...
- Apply linear interpolation between a macro variation texture and a base texture, base texture color variation, to reduce texture tiling across the open world map.
